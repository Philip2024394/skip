...
const FOOD_TIPS = [
  ...
  "Food markets (pasar) are sacred in Indonesian daily life. Asking her to show you her favourite local market is one of the most meaningful invitations she can extend.",
  ...
  "Tea (teh) and coffee (kopi) culture is deeply social. Sharing a glass of sweet tea together, especially in the early morning, is a special ritual many Indonesian women treasure.",
...
const FAMILY_TIPS = [
  ...
  "Respecting her parents — especially her father — is non-negotiable. In many Indonesian traditions, the father must give formal blessing before a serious relationship progresses.",
