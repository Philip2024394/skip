                  ...
                  <div className="flex gap-2">
                    {genderOptions.map((g) => (
                      <button key={g.value} onClick={() => setLocal((f) => ({ ...f, gender: g.value }))}
                        className={`flex-1 py-2 rounded-xl text-xs font-medium border transition-all ${local.gender === g.value ? "bg-primary text-primary-foreground border-primary shadow-md" : "bg-muted/30 text-muted-foreground border-border/50 hover:border-primary/50"
                          }`}>
                        {g.label}
                      </button>
                    ))}
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button key={o.value} onClick={() => setLocal((f) => ({ ...f, orientation: o.value }))}
                        className={`flex-1 py-2 rounded-xl text-xs font-medium border transition-all ${local.orientation === o.value ? "bg-primary text-primary-foreground border-primary shadow-md" : "bg-muted/30 text-muted-foreground border-border/50 hover:border-primary/50"
                          }`}>
                        {o.label}
                      </button>
                    ))}
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {lookingForOptions.map((l) => (
                      <button key={l.value} onClick={() => setLocal((f) => ({ ...f, lookingFor: l.value }))}
                        className={`px-4 py-2 rounded-xl text-xs font-medium border transition-all ${local.lookingFor === l.value ? "bg-primary text-primary-foreground border-primary shadow-md" : "bg-muted/30 text-muted-foreground border-border/50 hover:border-primary/50"
                          }`}>
                        {l.label}
                      </button>
                    ))}
                ...
                <div className="space-y-3">
                  ...
                  {[
                    ...
                    <button key={key} onClick={() => setLocal((f) => ({ ...f, [key]: !f[key] }))}
                      className={`w-full flex items-center justify-between p-3 rounded-xl border transition-all ${local[key] ? "bg-primary/10 border-primary/30" : "bg-muted/20 border-border/30"
                        }`}>
