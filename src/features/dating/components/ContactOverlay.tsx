...
const FAQ_ITEMS = [
  ...
  { q: "Why was my photo rejected?",                   a: "Photos must show a clear face, must not include inappropriate content, and must not include other people's faces without consent. Sunglasses and group photos are not accepted as your primary photo.", tags: ["photo","rejected","image","picture"] },
