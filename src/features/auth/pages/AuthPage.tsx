...
const AuthPage = () => {
  ...
  if (!showAuth) {
    ...
    const handleLandingEnter = async () => {
      ...
      if (!legalVerified) {
        toast.error("Please complete the legal verification by agreeing to Terms and Privacy Policy");
        return;
      }
              ...
              <div className="mt-3 space-y-3">
                ...
                {isAdminMode ? (
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Legal Agreement - Pink-themed Modal */}
                    <div className="flex flex-col space-y-3">
                      <button
                        onClick={() => setShowLegalModal(true)}
                        className="w-full p-3 bg-pink-500 hover:bg-pink-600 text-white rounded-xl font-semibold transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      {!legalVerified && (
                        <div className="text-center text-xs text-gray-500">
                          Legal agreement required to continue
                        </div>
                      )}
                    </div>
                    ...
                    <Button
                      ...
                      disabled={landingSubmitting || !landingNumber || !legalVerified}
