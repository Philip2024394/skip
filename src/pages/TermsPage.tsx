    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-2xl mx-auto px-5 py-8 pb-20">
        ...
        <Section title="2. Account Registration">
          ...
          <p>SkipTheApp is not liable for any loss or damage arising from your failure to keep your credentials secure.</p>
        </Section>
        ...
        <Section title="5. Premium Features & Payments">
          <p>Certain features of SkipTheApp require payment, including but not limited to:</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
        ...
        <Section title="6. WhatsApp Connections — Safety Notice">
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>SkipTheApp facilitates introductions only — we are not responsible for the conduct of users after a connection is made</li>
          ...
          <p>SkipTheApp is not liable for any harm, loss, or damage arising from interactions or meetings that take place outside the platform.</p>
        </Section>
        ...
        <Section title="7. Plus-One Feature — Companion Connections">
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <li>SkipTheApp takes no responsibility for arrangements, agreements, or events organised between members</li>
          </ul>
        </Section>

        <Section title="8. Intellectual Property">
          <p>The SkipTheApp brand, logo, design, and all proprietary software are owned by SkipTheApp and are protected by copyright, trademark, and other intellectual property laws. You may not copy, reproduce, distribute, or create derivative works without our express written permission.</p>
          <p>You retain ownership of content you upload to the Service. By uploading, you grant SkipTheApp a non-exclusive, worldwide, royalty-free licence to store, display, and use your content within the Service for the purpose of operating and improving the platform.</p>
        </Section>
        ...
        <Section title="11. Disclaimers">
          ...
          <p>SkipTheApp is a platform that facilitates connections between independent adult users. We are not a matchmaking agency and make no guarantees regarding the quality, safety, or suitability of any user.</p>
        </Section>

        <Section title="12. Limitation of Liability">
          <p>To the maximum extent permitted by applicable law, SkipTheApp, its directors, officers, employees, and partners shall not be liable for any:</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
        ...
        <Section title="13. Indemnification">
          <p>You agree to indemnify, defend, and hold harmless SkipTheApp and its affiliates from and against any claims, liabilities, damages, losses, and expenses (including reasonable legal fees) arising out of or in connection with your use of the Service, your content, or your violation of these Terms.</p>
        </Section>

        <Section title="14. Governing Law & Disputes">
          <p>These Terms shall be governed by and construed in accordance with applicable law. Any disputes arising from these Terms or your use of the Service shall first be attempted to be resolved informally by contacting us at <a href="mailto:support@skiptheapp.com" className="text-primary underline">support@skiptheapp.com</a>. If a dispute cannot be resolved informally, it shall be subject to the exclusive jurisdiction of the competent courts.</p>
        </Section>
        ...
        <Section title="16. Contact Us">
          ...
          <p className="mt-2">
            <strong className="text-white">SkipTheApp Support</strong><br />
            <a href="mailto:support@skiptheapp.com" className="text-primary underline">support@skiptheapp.com</a><br />
