...
export const translations = {
  ...
  "match.unlock299": { en: "Unlock WhatsApp — $2.99", id: "Buka WhatsApp — $2,99" },
  ...
  "filter.generousLifestyle": { en: "🎁 Generous Lifestyle", id: "🎁 Gaya Hidup Dermawan" },
  "filter.generousLifestyleDesc": { en: "Show only users with Generous Lifestyle badge", id: "Tampilkan pengguna dengan lencana Generous Lifestyle" },
  "filter.weekendPlans": { en: "📅 Weekend Plans", id: "📅 Rencana Akhir Pekan" },
  "filter.weekendPlansDesc": { en: "Show only users with Weekend Plans badge", id: "Tampilkan pengguna dengan lencana Rencana Akhir Pekan" },
  "filter.lateNightChat": { en: "🌙 Late Night Chat", id: "🌙 Obrolan Larut Malam" },
  "filter.lateNightChatDesc": { en: "Show only users with Late Night Chat badge", id: "Tampilkan pengguna dengan lencana Obrolan Larut Malam" },
  "filter.noDrama": { en: "✨ No Drama", id: "✨ No Drama" },
  "filter.noDramaDesc": { en: "Show only users with No Drama badge", id: "Tampilkan pengguna dengan lencana No Drama" },
  ...
  "detail.shareProfile": { en: "Share profile via WhatsApp", id: "Bagikan profil lewat WhatsApp" },
  ...
  "popup.unlockDesc299": { en: "Pay $2.99 to reveal both WhatsApp numbers. Both profiles will go offline for 3 days.", id: "Bayar $2,99 untuk membuka nomor WhatsApp. Kedua profil akan offline selama 3 hari." },
  ...
  "popup.pay299": { en: "Pay $2.99", id: "Bayar $2,99" },
