-- ── Blind Date AI Stories ────────────────────────────────────────────────────
-- Stores Claude-generated personal stories per profile.
-- Generated lazily on first blind-date view — cached forever after.

ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS blind_date_story_age      TEXT,
  ADD COLUMN IF NOT EXISTS blind_date_story_location TEXT,
  ADD COLUMN IF NOT EXISTS blind_date_story_intent   TEXT;

-- Update RPC to include story columns
